...
We have two flows (and thus pages):
 ...
 FLOW: Hiring manager opens the page to create the link for the application.
...
When the link has been successfully created it will be sent to the hiring manager’s email.
 ...
 FLOW: The applicant opens the page and first see’s an intro with the company name + job title (to make sure he’s applying for the right job).
